...
/**
 * The interactive registration form. Rendered by the server `RegisterPage`,
 * which passes the providers it has configured so social buttons only appear
 * when the server can handle them.
 *
 * @param {object} props
 * @param {string[]} [props.enabledProviders] - Configured social provider ids.
 */
export function RegisterForm({ enabledProviders = [] }) {
