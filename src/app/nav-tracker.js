...
import { shouldResetNavBaseline } from '@/lib/nav-back';
...
export function NavTracker() {
  useEffect(() => {
    ...
    const hasStoredBaseline = sessionStorage.getItem(NAV_BASELINE_KEY) !== null;
    if (shouldResetNavBaseline({ navigationType, hasStoredBaseline })) {
